const markdownTemplateHeader = [`| Gerätename | IP Adresse | MAC Adresse`, `| ---- | ---- | ----`]
 ...
 */
export function convertToMarkdownLines(arrayOfDevices: DeviceEntry[]): string[] {
 ...
 * @param arrayOfDevices Arrays of network devices
 */
export function createMarkdown(arrayOfDevices: DeviceEntry[]): string[] {
    try {
        let markdown: string[] = markdownTemplateHeader
